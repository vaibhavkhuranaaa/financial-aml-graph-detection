...
def test_public_runtime_pins_release_identity() -> None:
    fixture = Path("data/fixtures/public_casefile.json")
    with pytest.raises(ValueError, match="release digest"):
        approved_public_artifact(fixture, expected_sha256="0" * 64)
    with pytest.raises(ValueError, match="pipeline run"):
        approved_public_artifact(fixture, expected_pipeline_run_id="0" * 64)
